# Copilot Chat Conversation Export: Add trading bot to daytrader-swingtrader

**User:** @austinmhill88
**Thread URL:** https://github.com/copilot/c/593842bd-2b34-4773-9739-ef8b56dee46f

## @austinmhill88

hey can you give me instructions to build the most sophisticated swing/day trading bot you can devise? one that would perform well in a live trading setting. it would be ran using alpaca trading api. it would use whatever money you put into it and trade with it. I need very specific instructions and all specs and as much detail as possible
...
- url: ""
  ...
  state: ""
  draft: false
  title: "This is not a GitHub issue list. No issues were fetched."
  number: 0
  created_at: ""
  closed_at: ""
  merged_at: ""
...
```python name=src/logging_utils.py
...
```python name=src/alpaca_client.py
...
```python name=src/strategies/base.py
...
```python name=src/strategies/intraday_mean_reversion.py
import pandas as pd
from typing import List
from src.models import Signal
...
class IntradayMeanReversion:
    ...
    def on_bar(self, bar) -> List[Signal]:
        ...
        # Confidence can be a function of |z| and liquidity (placeholder 0.7)
...
```python name=src/strategies/swing_trend_following.py
import pandas as pd
from typing import List
from src.models import Signal
...
```python name=src/risk_manager.py
...
```python name=src/execution_engine.py
import math
...
```python name=backtest/backtester.py
import argparse
import pandas as pd
from loguru import logger
...
5) Historical data for warm-up/backtest
...
8) Live trading (after successful paper phase and incremental capital ramp)
