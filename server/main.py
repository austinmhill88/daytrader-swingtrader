...
def make_app() -> FastAPI:
    ...
    # Initialize model registry and runtime
    ...
    # Network and file sandbox config
    ...
    app = FastAPI(
        ...
        version="0.1.0",
        description="Ollama-compatible API with web browsing and file access"
    )
    ...
    app.include_router(make_web_router(allow_network))
